  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col space-y-3 p-4">
      {messages.map((msg) => (
        ...
        >
          <div
            className={`max-w-[70%] rounded-2xl px-4 py-2 wrap-break-word ${msg.sender === "user" ? "rounded-bl-none bg-blue-500 text-white" : "rounded-br-none bg-gray-300 text-gray-900"} `}
          >
            {msg.text}
          </div>
        </div>
